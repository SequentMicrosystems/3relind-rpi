...
const CliCmdType CMD_RS485_READ =
{
	...
	"\tUsage:		3relind <id> rs485rd\n",
	"",
	"\tExample:		3relind 0 rs485rd; Read the RS485 settings on Board #0\n"};
...
const CliCmdType CMD_RS485_WRITE =
	{
		...
		"\tUsage:		3relind <id> rs485wr <mode> <baudrate> <stopBits> <parity> <slaveAddr>\n",
		"",
		"\tExample:		3relind 0 rs485wr 1 9600 1 0 1; Write the RS485 settings on Board #0 \n\t\t\t(mode = Modbus RTU; baudrate = 9600 bps; stop bits one; parity none; modbus slave address = 1)\n"};
